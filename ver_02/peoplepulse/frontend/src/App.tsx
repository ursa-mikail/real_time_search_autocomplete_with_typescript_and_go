...
const HINTS = ['alice chen','rust engineer','RAG pipelines','kubernetes','open source','eBPF','Mistral','Temporal'];
const PHS   = [
      ...
      <main className="main">
        ...
        <header className="hdr">
          <div className="logo">
            ...
            <span className="logo-txt">People<em>Pulse</em></span>
          </div>
          <p className="tagline">Find engineers, researchers & builders · live from Postgres</p>
        </header>
        ...
        <footer className="foot">
          PeoplePulse · Go · PostgreSQL · React · TypeScript
        </footer>
      </main>
    </div>
  );
